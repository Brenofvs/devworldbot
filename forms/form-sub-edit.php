                        ...
                        <div class="d-table-cell align-top">
                            ...
                            <div class="text-center mt-4">
                                <div class="d-flex mb-4 justify-content-between">
                                    <h1 class="h2">Editar subcategoria!</h1>
                            ...
                            <div class="card mt-4">
                                <div class="card-body ">
                                    <div class="m-sm-4">
                                        <form name='post' action='./?page=sub-edit&postId=<?= $postUpdt->sub_id ?>' method='post' enctype='multipart/form-data'>
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea style="resize: none" rows="1" class="form-control form-control-lg" name='subcategoria'><?= $postUpdt->subcategoria ?></textarea>
                                            </div>
