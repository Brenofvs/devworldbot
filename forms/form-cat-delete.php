                ...
                <div class="col-sm-12 col-md-11 col-lg-10 mx-auto d-table h-100">
                    <div class="d-table-cell align-top">
                        ...
                        <div class="card mt-4">
                            <div class="card-body ">
                                <div class="m-sm-4">
                                    <form name='post' action='./?page=cat-delete&postId=<?= $postDel->categoria_id ?>&delete=true' method='post' enctype='multipart/form-data'>
                                        <div class="mb-3">
                                            <label class="form-label">Categoria</label>
                                            <textarea rows="1" class="form-control form-control-lg text-dark" name='categoria' value='' placeholder='' disabled><?= $postDel->categoria ?></textarea>
                                        </div>
